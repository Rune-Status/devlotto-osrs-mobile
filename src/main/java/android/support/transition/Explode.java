...
public class Explode extends Visibility {
    ...
    public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        return TranslationAnimationCreator.createAnimation(view, transitionValues2, rect.left, rect.top, translationX + ((float) this.mTempLoc[0]), ((float) this.mTempLoc[1]) + translationY, translationX, translationY, sDecelerate);
    }
