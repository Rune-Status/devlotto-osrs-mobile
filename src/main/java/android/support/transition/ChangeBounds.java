...
public class ChangeBounds extends Transition {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (i2 > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    Animator ofPointF = (i3 == i && i4 == i5) ? null : ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath((float) i3, (float) i4, (float) i, (float) i5));
                    rect2 = rect == null ? new Rect(0, 0, i10, i11) : rect;
                    if (rect3 == null) {
                    ...
                    if (rect2.equals(rect4)) {
                        ...
                        Animator ofObject = ObjectAnimator.ofObject(view, "clipBounds", sRectEvaluator, new Object[]{rect2, rect4});
                    ...
                    mergeAnimators = TransitionUtils.mergeAnimators(ofPointF, animator);
                } else {
                    ViewUtils.setLeftTopRightBottom(view, i3, i4, i6, i8);
                    if (i2 != 2) {
                        mergeAnimators = (i3 == i && i4 == i5) ? ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath((float) i6, (float) i8, (float) i7, (float) i9)) : ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath((float) i3, (float) i4, (float) i, (float) i5));
                        ...
                        ObjectAnimator ofPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath((float) i3, (float) i4, (float) i, (float) i5));
                        ObjectAnimator ofPointF3 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath((float) i6, (float) i8, (float) i7, (float) i9));
                        animator = new AnimatorSet();
                        animator.playTogether(new Animator[]{ofPointF2, ofPointF3});
        ...
        if (!(i2 == i && intValue == intValue2)) {
            ...
            Path path = getPathMotion().getPath((float) (i2 - this.mTempLocation[0]), (float) (intValue - this.mTempLocation[1]), (float) (i - this.mTempLocation[0]), (float) (intValue2 - this.mTempLocation[1]));
            ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(bitmapDrawable, new PropertyValuesHolder[]{PropertyValuesHolderUtils.ofPointF(DRAWABLE_ORIGIN_PROPERTY, path)});
