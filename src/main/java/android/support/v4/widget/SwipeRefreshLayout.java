...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                abs = (int) (((float) (abs - SwipeRefreshLayout.this.mFrom)) * f);
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((abs + SwipeRefreshLayout.this.mFrom) - SwipeRefreshLayout.this.mCircleView.getTop());
    ...
    private void moveSpinner(float f) {
        ...
        float f3 = (float) i;
        double max2 = (double) (Math.max(0.0f, Math.min(abs - f2, f3 * DECELERATE_INTERPOLATION_FACTOR) / f3) / 4.0f);
        abs = ((float) (max2 - Math.pow(max2, 2.0d))) * DECELERATE_INTERPOLATION_FACTOR;
        int i2 = this.mOriginalOffsetTop;
        i = (int) (((f3 * abs) * DECELERATE_INTERPOLATION_FACTOR) + (min * f3));
        ...
        this.mProgress.setProgressRotation((((max * 0.4f) - 0.25f) + (abs * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (getChildCount() != 0) {
            ...
            if (this.mTarget != null) {
                ...
                measuredWidth /= 2;
                measuredHeight /= 2;
                this.mCircleView.layout(measuredWidth - measuredHeight, this.mCurrentTargetOffsetTop, measuredWidth + measuredHeight, this.mCurrentTargetOffsetTop + this.mCircleView.getMeasuredHeight());
            }
        }
    }
