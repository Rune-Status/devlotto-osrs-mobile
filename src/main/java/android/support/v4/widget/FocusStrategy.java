...
class FocusStrategy {
    ...
    private static boolean beamBeats(int i, @NonNull Rect rect, @NonNull Rect rect2, @NonNull Rect rect3) {
        return (beamsOverlap(i, rect, rect3) || !beamsOverlap(i, rect, rect2)) ? false : !isToDirectionOf(i, rect, rect3) ? true : i != 17 ? i == 66 ? true : majorAxisDistance(i, rect, rect2) < majorAxisDistanceToFarEdge(i, rect, rect3) : true;
    }
