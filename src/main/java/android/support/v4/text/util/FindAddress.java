...
class FindAddress {
    ...
    private static int attemptMatch(String str, MatchResult matchResult) {
        ...
        while (end < str.length()) {
            ...
            int i6 = end;
            while (i6 < matcher.start()) {
                if (NL.indexOf(str.charAt(i6)) != -1) {
                    i2++;
                }
                i6++;
            }
            ...
            if (matchHouseNumber(str, i6) == null) {
                if (!isValidLocationName(matcher.group(0))) {
                    ...
                    if (obj2 != null && i5 > 4) {
                        MatchResult matchState = matchState(str, i6);
                        if (matchState != null) {
    ...
    private static boolean checkHouseNumber(String str) {
        ...
        String toLowerCase = matcher.group(2).toLowerCase(Locale.getDefault());
        switch (i % 10) {
            case 1:
                return toLowerCase.equals(i % 100 == 11 ? "th" : "st");
            case 2:
                return toLowerCase.equals(i % 100 == 12 ? "th" : "nd");
            case 3:
                return toLowerCase.equals(i % 100 == 13 ? "th" : "rd");
            default:
                return toLowerCase.equals("th");
        }
    }
    ...
    private static boolean isValidZipCode(String str, MatchResult matchResult) {
        ...
        i = groupCount;
        boolean z = sZipCodeRe.matcher(str).matches() && sStateZipCodeRanges[i].matches(str);
        return z;
    }
    ...
    public static MatchResult matchHouseNumber(String str, int i) {
        ...
        return checkHouseNumber(toMatchResult.group(0)) ? toMatchResult : null;
    }
    ...
    public static MatchResult matchState(String str, int i) {
        ...
        return region.lookingAt() ? region.toMatchResult() : null;
    }
}
