...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public Notification buildInternal() {
        ...
        Notification build;
        SparseArray buildActionExtrasMap;
        if (VERSION.SDK_INT >= 24) {
            ...
            buildActionExtrasMap = NotificationCompatJellybean.buildActionExtrasMap(this.mActionExtrasList);
            ...
            buildActionExtrasMap = NotificationCompatJellybean.buildActionExtrasMap(this.mActionExtrasList);
            if (buildActionExtrasMap != null) {
                NotificationCompat.getExtras(build2).putSparseParcelableArray(NotificationCompatExtras.EXTRA_ACTION_EXTRAS, buildActionExtrasMap);
            }
            if (this.mContentView != null) {
