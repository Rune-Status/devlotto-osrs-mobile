...
class NotificationCompatJellybean {
                ...
                if (actionObjectsLocked != null) {
                    ...
                    if (extras != null) {
                        ...
                        if (sparseParcelableArray != null) {
                            ...
                            readAction = readAction(sActionIconField.getInt(obj), (CharSequence) sActionTitleField.get(obj), (PendingIntent) sActionIntentField.get(obj), bundle);
                            return readAction;
                        }
                    }
                    bundle = null;
    ...
    public static Action readAction(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            fromBundleArray2 = fromBundleArray(getBundleArrayFromBundle(bundle, EXTRA_DATA_ONLY_REMOTE_INPUTS));
        ...
        return new Action(i, charSequence, pendingIntent, bundle, fromBundleArray, fromBundleArray2, z, 0, true);
    }
