...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        ...
        return nestedScrollingParentForType != null ? ViewParentCompat.onNestedFling(nestedScrollingParentForType, this.mView, f, f2, z) : false;
    }
    ...
    public boolean dispatchNestedPreFling(float f, float f2) {
        ...
        ViewParent nestedScrollingParentForType = getNestedScrollingParentForType(0);
        return nestedScrollingParentForType != null ? ViewParentCompat.onNestedPreFling(nestedScrollingParentForType, this.mView, f, f2) : false;
    }
