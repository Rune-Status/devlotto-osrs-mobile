...
public class ViewCompat {
    ...
    static class UnhandledKeyEventManager {
        ...
        private View dispatchInOrder(View view, KeyEvent keyEvent) {
            ...
            return !onUnhandledKeyEvent(view, keyEvent) ? null : view;
        }
        ...
        static void unregisterListeningView(View view) {
            synchronized (sViewsWithListeners) {
                ...
                while (true) {
                    int i2 = i;
                    if (i2 >= sViewsWithListeners.size()) {
                        return;
                    } else if (((WeakReference) sViewsWithListeners.get(i2)).get() == view) {
    ...
    public static ColorStateList getBackgroundTintList(@NonNull View view) {
        return VERSION.SDK_INT >= 21 ? view.getBackgroundTintList() : view instanceof TintableBackgroundView ? ((TintableBackgroundView) view).getSupportBackgroundTintList() : null;
    }

    public static Mode getBackgroundTintMode(@NonNull View view) {
        return VERSION.SDK_INT >= 21 ? view.getBackgroundTintMode() : view instanceof TintableBackgroundView ? ((TintableBackgroundView) view).getSupportBackgroundTintMode() : null;
    }
    ...
    public static String getTransitionName(@NonNull View view) {
        return VERSION.SDK_INT >= 21 ? view.getTransitionName() : sTransitionNameMap == null ? null : (String) sTransitionNameMap.get(view);
    }
