...
final class GradientColorInflaterCompat {
    ...
    static Shader createFromXmlInner(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Theme theme) throws IOException, XmlPullParserException {
        ...
        if (name.equals("gradient")) {
            ...
            int namedInt = TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, Param.TYPE, R.styleable.GradientColor_android_type, 0);
    ...
    /* JADX WARNING: Missing block: B:17:0x0088, code skipped:
            throw new org.xmlpull.v1.XmlPullParserException(r0.toString());
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static ColorStops inflateChildElements(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth2 < depth && next == 3) {
                ...
                if (hasValue && hasValue2) {
                    depth2 = obtainAttributes.getColor(R.styleable.GradientColorItem_android_color, 0);
                    float f = obtainAttributes.getFloat(R.styleable.GradientColorItem_android_offset, 0.0f);
                    obtainAttributes.recycle();
                    arrayList2.add(Integer.valueOf(depth2));
        ...
        return arrayList2.size() > 0 ? new ColorStops(arrayList2, arrayList) : null;
    }
