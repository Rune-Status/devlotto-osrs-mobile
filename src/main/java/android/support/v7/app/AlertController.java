...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                Object simpleCursorAdapter2 = new CursorAdapter(this.mContext, this.mCursor, false) {
            ...
            alertController.mAdapter = simpleCursorAdapter2;
    ...
    private void setupView() {
        ...
        if (!z) {
            findViewById2 = this.mListView != null ? this.mListView : this.mScrollView;
            if (findViewById2 != null) {
                setScrollIndicators(resolvePanel2, findViewById2, (z3 ? 2 : 0) | z2, 3);
            }
        }
