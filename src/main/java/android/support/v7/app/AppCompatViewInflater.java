...
public class AppCompatViewInflater {
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            if (-1 == str.indexOf(46)) {
                for (String createViewByPrefix2 : sClassPrefixList) {
                    createViewByPrefix = createViewByPrefix(context, str, createViewByPrefix2);
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        View createViewFromTag = (createTextView != null || context == context2) ? createTextView : createViewFromTag(context2, str, attributeSet);
