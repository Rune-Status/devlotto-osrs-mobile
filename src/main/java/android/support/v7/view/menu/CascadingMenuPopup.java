...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        return i2 >= 0 ? i2 >= listView.getChildCount() ? null : listView.getChildAt(i2) : null;
    }
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            ...
            Object cascadingMenuInfo3 = null;
        }
        if (findParentViewForSubmenu != null) {
            ...
            if (VERSION.SDK_INT >= 26) {
                ...
                nextMenuPosition = iArr2[0] - iArr[0];
                i = iArr2[1] - iArr[1];
            }
            int width = (this.mDropDownGravity & 5) == 5 ? z ? nextMenuPosition + measureIndividualMenuWidth : nextMenuPosition - findParentViewForSubmenu.getWidth() : z ? findParentViewForSubmenu.getWidth() + nextMenuPosition : nextMenuPosition - measureIndividualMenuWidth;
        ...
        if (cascadingMenuInfo3 == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
