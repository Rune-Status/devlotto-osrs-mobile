...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (this.mReserveOverflow && (obj != null || i6 + i5 > i3)) {
            i3--;
        }
        int i8 = i3 - i5;
        ...
        if (this.mStrictWidthLimit) {
            ...
            i5 = ((i4 % this.mMinCellSize) / i2) + this.mMinCellSize;
        } else {
            i2 = 0;
            i5 = 0;
        }
        ...
        while (i9 < size) {
            ...
            if (menuItemImpl.requiresActionButton()) {
                ...
                if (this.mStrictWidthLimit) {
                    i2 -= ActionMenuView.measureChildForCells(itemView, i5, i2, makeMeasureSpec, 0);
                } else {
                ...
                if (z3) {
                    ...
                    if (this.mStrictWidthLimit) {
                        int measureChildForCells = ActionMenuView.measureChildForCells(itemView2, i5, i2, makeMeasureSpec, 0);
    ...
    public void updateMenuView(boolean z) {
        ...
        if (this.mReserveOverflow && nonActionItems != null) {
            ...
            if (i == 1) {
                isActionViewExpanded = ((MenuItemImpl) nonActionItems.get(0)).isActionViewExpanded() ^ 1;
            } else if (i > 0) {
                isActionViewExpanded = 1;
            }
            if (isActionViewExpanded == 0) {
                if (this.mOverflowButton == null) {
                    this.mOverflowButton = new OverflowMenuButton(this.mSystemContext);
                }
