        ...
        if (isEmpty != 0 || isEmpty2 != 0 || isEmpty4 != 0 || isEmpty3 != 0) {
            ...
            if (isEmpty4 != 0) {
                ...
                if (isEmpty == 0 && isEmpty2 == 0 && isEmpty3 == 0) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, anonymousClass3, Math.max(isEmpty2 != 0 ? getMoveDuration() : 0, isEmpty3 != 0 ? getChangeDuration() : 0) + (isEmpty != 0 ? getRemoveDuration() : 0));
                }
            }
        }
    }
