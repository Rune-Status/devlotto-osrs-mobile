...
class ViewBoundsCheck {
    ...
    static class BoundFlags {
        ...
        public boolean boundsMatch() {
            return ((this.mBoundFlags & 7) == 0 || (this.mBoundFlags & (compare(this.mChildStart, this.mRvStart) << 0)) != 0) ? ((this.mBoundFlags & 112) == 0 || (this.mBoundFlags & (compare(this.mChildStart, this.mRvEnd) << 4)) != 0) ? ((this.mBoundFlags & ox.ak) == 0 || (this.mBoundFlags & (compare(this.mChildEnd, this.mRvStart) << 8)) != 0) ? (this.mBoundFlags & 28672) == 0 || (this.mBoundFlags & (compare(this.mChildEnd, this.mRvEnd) << 12)) != 0 : false : false : false;
        }
